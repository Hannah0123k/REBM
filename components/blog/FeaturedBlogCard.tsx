...
export function FeaturedBlogCard({ post }: { post: BlogPlaceholder }) {
  return (
    <article className="mx-auto flex min-h-[190px] w-full max-w-[820px] flex-col items-center justify-center overflow-hidden rounded-[24px] bg-rebm-blue px-[32px] py-[28px] text-center">
